...
def create_question(question_text, days):
    ...
    the given number of 'days' offset to now (negative for quesitons published
...
class QuestionIndexViewTests(TestCase):
    def test_no_question(self):
        """
        If no question exsit, an approrite massage is displayed.
        """
    ...
    def test_two_past_questions(self):
        """
        The question index page may display multiple quesitons
        """
...
# [python manage.py test polls] run in terminal
# find subclass django.test.TestCase  ;
# setup a special database for testing purpose;
...
# using the assertIs() method, it discovered that its was_published_recently()
